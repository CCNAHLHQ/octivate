...
function applySecurityHeaders(req: NextRequest, res: NextResponse) {
  ...
  res.headers.set(
    ...
    [
      ...
      "img-src 'self' data: blob: https://flagcdn.com https://www.gstatic.com https://translate.googleapis.com https://*.googleusercontent.com",
      "font-src 'self' data: https://fonts.gstatic.com",
      "connect-src 'self' https://www.google.com https://*.googleapis.com https://www.gstatic.com https://translate.googleapis.com https://translate.google.com https://*.supabase.co wss://*.google.com",
